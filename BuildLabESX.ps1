...
# The below doesn't seem to work as it just created a new transport zone
#New-NsxTransportZone -name $config.global.transzone -Cluster (get-cluster -name $config.global.Cluster) -ControlPlaneMode UNICAST_MODE
